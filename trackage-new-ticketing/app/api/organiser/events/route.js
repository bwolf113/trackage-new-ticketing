      ...
      html: `
        <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px">
          ...
          <div style="margin-top:20px;text-align:center">
            <a href="${siteUrl}/admin/events?edit=${event.id}" style="display:inline-block;background:#0a0a0a;color:#fff;padding:11px 24px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:700">View event →</a>
